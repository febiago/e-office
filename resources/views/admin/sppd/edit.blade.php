            ...
            <div class="row">
                <div class="col-12 col-md-12 col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('sppd.updated', $sppd->surat_keluar_id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')

                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        <label for="surat_keluar_id">No SPT</label>
                                        <select name="surat_keluar_id"
                                            class="form-control select2 @error('surat_keluar_id') is-invalid @enderror">
                                            @foreach($sppds as $key => $value)
                                                <option value="{{ $key }}" {{ $sppd->surat_keluar_id == $key ? 'selected' : '' }}>{{ $value }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="keterangan"
                                            value="{{ $sppd->keterangan }}" name="keterangan">
                                        <div class="alert alert-danger mt-2 d-none" role="alert"
                                            id="alert-keterangan"></div>
                                    </div>
                                </div>
                                <h4>Pengikut</h4>
